  ...
  return (
    <section className="flex-1 flex items-center justify-center py-20">
      <div className="text-center px-4">
        ...
        <h2 className="text-2xl font-light text-gray-600 mb-6">Страницата не е намерена</h2>
        <p className="text-gray-500 max-w-md mx-auto mb-8">
          Съжаляваме, не можахме да намерим страницата, която търсите. Може да е преместена или
          да не съществува.
        </p>
